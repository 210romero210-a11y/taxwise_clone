...
/**
 * State Tax Withholding Form Data Entry Page
 * 
 * Route: /forms/state-wh
 * 
 * This page provides the data entry interface for state tax withholding certificates.
 * State withholding forms vary by state but generally include employee and employer information
 * along with withholding election details.
 */
export default function StateWithholdingPage() {
  ...
  const formDefinitions = useQuery(
    ...
    { formCode: "STATE_WH", year: taxYear }
  );
